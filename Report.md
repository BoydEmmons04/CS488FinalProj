...
Airfare pricing is shaped by a combination of operational, economic, and market factors. In the U.S. airline industry, capacity management, route-level competition, fuel costs, and operational disruptions such as delays are commonly cited determinants of fares. According to "Flight Delay Impact on Airfare and Flight Frequency: A Comprehensive Assessment" by Zou and Hansen (2014), delays increase airline operating costs and are partially passed on to passengers through higher fares, demonstrating how operational inefficiencies directly translate into pricing outcomes (Zou & Hansen, pp. 3–4).

Beyond operational costs, strategic supply decisions also influence fares. In "Airline Competition: The Average Number of Competitors in Markets Serving the Majority of Passengers Has Changed Little in Recent Years" by the U.S. Government Accountability Office (2014), findings indicate that airlines have increasingly relied on capacity restraint—limiting available seats relative to demand—to maintain profitability and support higher ticket prices, even in markets where competition persists (GAO, pp. 1–2).
...
This hypothesis is further motivated by observed pricing behavior. In "The Welfare Effects of Dynamic Pricing: Evidence from Airline Markets" by Williams (2021), the author demonstrates that airlines systematically adjust fares in response to demand timing and differences in willingness to pay, increasing prices as departure approaches to capture less price-sensitive travelers (Williams, pp. 2–6). This dynamic pricing mechanism suggests that when capacity becomes scarce—reflected in high load factors—airlines may be positioned to exercise greater pricing power.
...
- U.S. Government Accountability Office. (2014). *Airline Competition: The Average Number of Competitors in Markets Serving the Majority of Passengers Has Changed Little in Recent Years* (GAO-14-515). https://www.gao.gov/products/gao-14-515
